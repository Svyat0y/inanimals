...
function changeSlides(a) {
  a || (animating = !0, manageControls(), $slider.addClass("animating"), $slider.css("top"), $(".slide").removeClass("active"), $(".slide-" + curSlide).addClass("active"), setTimeout(function () {
    $slider.removeClass("animating"), animating = !1
  }, animTime)), window.clearTimeout(autoSlideTimeout), $(".slider-pagi__elem").removeClass("active"), $(".slider-pagi__elem-" + curSlide).addClass("active"), $slider.css("transform", "translate3d(" + 100 * -curSlide + "%,0,0)"), $slideBGs.css("transform", "translate3d(" + 50 * curSlide + "%,0,0)"), diff = 0, autoSlide()
}
...
var $slider = $(".slider"), $slideBGs = $(".slide__bg"), diff = 0, curSlide = 0, numOfSlides = $(".slide").length - 1, animating = !1, animTime = 500, autoSlideTimeout, autoSlideDelay = 5000, $pagination = $(".slider-pagi");
createBullets(), autoSlide(), $(document).on("mousedown touchstart", ".slider", function (a) {
  if (!animating) {
    window.clearTimeout(autoSlideTimeout);
    var b = a.pageX || a.originalEvent.touches[0].pageX, c = $(window).width();
    diff = 0, $(document).on("mousemove touchmove", function (a) {
      var d = a.pageX || a.originalEvent.touches[0].pageX;
      diff = (b - d) / c * 70, (!curSlide && diff < 0 || curSlide === numOfSlides && diff > 0) && (diff /= 2), $slider.css("transform", "translate3d(" + (100 * -curSlide - diff) + "%,0,0)"), $slideBGs.css("transform", "translate3d(" + (50 * curSlide + diff / 2) + "%,0,0)")
    })
  }
...
!function ($) {
  function numberRoller(a) {
    var b = $(".roller-title-number-" + a).attr("data-min"), c = $(".roller-title-number-" + a).attr("data-max"), d = $(".roller-title-number-" + a).attr("data-delay"), e = $(".roller-title-number-" + a).attr("data-increment"), f = c - b, g = 1e3 * d / f;
  ...
  $(window).on("load", function () {
    ...
    var b = $.extend({ showFunction: null, hideFunction: null, showShift: 0, wholeVisible: !1, hideShift: 0 }, a);
    return this.each(function (a, c) {
      $(this).addClass("scrollzip");

      // causes js error
      // $.isFunction(b.showFunction)
      //   && !$(this).hasClass("isShown")
      //   && $(window).outerHeight() + $("#scrollzipPoint").offset().top - b.showShift > $(this).offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) && $("#scrollzipPoint").offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) < $(this).outerHeight() + $(this).offset().top - b.showShift && ($(this).addClass("isShown"), b.showFunction.call(this)), $.isFunction(b.hideFunction) && $(this).hasClass("isShown") && ($(window).outerHeight() + $("#scrollzipPoint").offset().top - b.hideShift < $(this).offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) || $("#scrollzipPoint").offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) > $(this).outerHeight() + $(this).offset().top - b.hideShift) && ($(this).removeClass("isShown"), b.hideFunction.call(this)), this
    })
  }
}(jQuery);
...
!function (t, i) {
  ...
  var ve, ye, xe = (Object.freeze || Object)({
    ...
    options: {
      ...
      var m = Math.max(d.x, d.y), g = m * this.getZoomScale(p, i), v = _.distanceTo(c) || 1, y = 1.42, x = y * y, w = n(0), L = Date.now(), P = (n(1) - w) / y, b = e.duration ? 1e3 * e.duration : 1e3 * P * .8;
      ...
      if (t = this._locateOptions = i({ timeout: 1e4, watch: !1 }, t), !("geolocation" in navigator))return this._handleGeolocationError({
        code: 0,
      ...
      t = z(t), e = w(e || [0, 0]);
      var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(e), u = b(this.project(a, n), this.project(r, n)).getSize(), l = Ni ? this.options.zoomSnap : 1, c = h.x / u.x, _ = h.y / u.y, d = i ? Math.max(c, _) : Math.min(c, _);
      ...
      if (!e)return t;
      var n = this.project(t, i), o = this.getSize().divideBy(2), s = new P(n.subtract(o), n.add(o)), r = this._getBoundsOffset(s, e, i);
  ...
  var Te = Pe.extend({
    options: {
      collapsed: !0, position: "topright", autoZIndex: !0, hideSingleBase: !1, sortLayers: !1, sortFunction: function (t, i, e, n) {
  ...
  var Se, Ee = { Events: hi }, ke = Vi ? "touchstart mousedown" : "mousedown", Ie = {
    mousedown: "mouseup",
    touchstart: "touchend",
    pointerdown: "touchend",
    MSPointerDown: "touchend"
  }, Ae = { mousedown: "mousemove", touchstart: "touchmove", pointerdown: "touchmove", MSPointerDown: "touchmove" }, Be = ui.extend({
    ...
    R: 6378137, R_MINOR: 6356752.314245179, bounds: new P([-20037508.34279, -15496570.73972], [20037508.34279, 18764656.23138]), project: function (t) {
  ...
  }), He = i({}, _i, { code: "EPSG:4326", projection: De, transformation: S(1 / 180, 1, -1 / 180, .5) }), Fe = i({}, ci, {
    projection: De,
  ...
  var Ve = Ue.extend({
    ...
    initialize: function (t) {
      ...
      var i = this._marker, e = i._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = L.DomUtil.getPosition(i._icon), r = e.getPixelBounds(), a = e.getPixelOrigin(), h = b(r.min._subtract(a).add(o), r.max._subtract(a).subtract(o));
      if (!h.contains(s)) {
    ...
    initialize: function (t, e, n) {
      ...
      if (n.distance === _i.distance) {
        var o = Math.PI / 180, s = this._mRadius / _i.R / o, r = e.project([i + s, t]), a = e.project([i - s, t]), h = r.add(a).divideBy(2), u = e.unproject(h).lat, l = Math.acos((Math.cos(s * o) - Math.sin(i * o) * Math.sin(u * o)) / (Math.cos(i * o) * Math.cos(u * o))) / o;
  ...
  var sn = Kt, rn = Ue.extend({
    options: { opacity: 1, alt: "", interactive: !1, crossOrigin: !1, errorOverlayUrl: "", zIndex: 1, className: "" }, initialize: function (t, i, e) {
      ...
      var t = this._image, i = new P(this._map.latLngToLayerPoint(this._bounds.getNorthWest()), this._map.latLngToLayerPoint(this._bounds.getSouthEast())), e = i.getSize();
  ...
  var ln = hn.extend({
    options: { pane: "tooltipPane", offset: [0, 0], direction: "auto", permanent: !1, sticky: !1, interactive: !1, opacity: .9 }, onAdd: function (t) {
  ...
  var _n = Ue.extend({
    options: {
      ...
      if (i) {
        ...
        if (void 0 === t && (t = i.getCenter()), void 0 !== this._tileZoom) {
          var n = this._getTiledPixelBounds(t), o = this._pxBoundsToTileRange(n), s = o.getCenter(), r = [], a = this.options.keepBuffer, h = new P(o.getBottomLeft().subtract([a, -a]), o.getTopRight().add([a, -a]));
    ...
    getTileUrl: function (t) {
      var i = this._tileCoordsToNwSe(t), e = this._crs, n = b(e.project(i[0]), e.project(i[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === He ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = L.TileLayer.prototype.getTileUrl.call(this, t);
  ...
  var mn = Ue.extend({
    options: { padding: .1, tolerance: 0 }, initialize: function (t) {
      ...
      var e = this._map.getZoomScale(i, this._zoom), n = Pt(this._container), o = this._map.getSize().multiplyBy(.5 + this.options.padding), s = this._map.project(this._center, i), r = this._map.project(t, i).subtract(s), a = o.multiplyBy(-e).add(n).add(o).subtract(r);
  ...
  var Tn = Ze.extend({
    keyCodes: { left: [37], right: [39], down: [40], up: [38], zoomIn: [187, 107, 61, 171], zoomOut: [189, 109, 54, 173] }, initialize: function (t) {
      ...
      t.tabIndex <= 0 && (t.tabIndex = "0"), V(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this), this._map.on({
        focus: this._addHooks,
        blur: this._removeHooks
      }, this)
    }, removeHooks: function () {
      this._removeHooks(), q(this._map._container, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this), this._map.off({
        focus: this._addHooks,
        blur: this._removeHooks
      }, this)
